...
class GroupsMiddleware {
    ...
    //     const user = await groupService.getUserByUserName(dbConnection, req.body.userName);
    //     if (user) {
    ...
    // ) {
    //     const dbConnection = connectionManager.getTenantDbConnection((req as any).tenantId);
    //     const user = await groupService.getUserByExternalId(dbConnection, req.body.externalId);
    //     if (user) {
    ...
    // ) {
    //     const dbConnection = connectionManager.getTenantDbConnection((req as any).tenantId);
    //     const user = await groupService.getUserByEmail(dbConnection, req.body.email);
    //     if (user) {
    ...
    // ) {
    //     const dbConnection = connectionManager.getTenantDbConnection((req as any).tenantId);
    //     const user = await groupService.readById(dbConnection, req.params.userId, '');
    //     if (user) {
    //         next();
    //     } else {
